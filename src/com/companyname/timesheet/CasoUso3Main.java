...
public class CasoUso3Main {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		//RegistroHorasInteractor it = new RegistroHorasInteractor(); // replaced by Spring
		...
		//ListadoHorasInteractor listadoHoras = new ListadoHorasInteractor(TimesheetRepositoryImpl.getInstance()); //replaced by Spring
